...
def arg():
	...
	parser.add_argument('--runs_name', type=str, default='multi_scale', help='logs and checkpoint saving folder')
	...
	parser.add_argument('--infer_model', type=str, default='./savedmodel/nature.mdl', help='the test data folder')
